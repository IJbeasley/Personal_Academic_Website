...
<details> <summary> 
<b> Active Site: </b> </summary> 
<br> 

The region on the *enzyme* that enables a specific substrate to bind to it. 

VCAA <i> “a particular position/specific site on an enzyme which attaches to a specific substrate” </i>
<br> 
